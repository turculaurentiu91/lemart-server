...
var render = function() {
  ...
  return _c("Layout", [
    _c("h2", { staticClass: "w3-border-bottom" }, [_vm._v("Acasa")]),
    _vm._v(" "),
    _c("div", { staticClass: "w3-row-padding" }, [
      _c("div", { staticClass: "w3-col l6 m12" }, [
        _c("div", { staticClass: "w3-card-2 w3-display-container home-card" }, [
          _c("h3", { staticClass: "w3-light-gray w3-padding" }, [
            _vm._v("Nuove Richeste:\n                  "),
            _vm.$page.user.unreadStandardRequests.length > 0
              ? _c("b", [
                  _vm._v(
                    "\n                      " +
                      _vm._s(_vm.$page.user.unreadStandardRequests.length) +
                      "\n                  "
                  )
                ])
              : _vm._e()
          ...
          _c("div", { staticClass: "w3-responsive" }, [
            _vm.$page.user.unreadStandardRequests.length > 0
              ? _c(
                  "table",
                  { staticClass: "w3-table w3-bordered w3-hoverable" },
                  [
                    _c("tr", [
                      _c("th", [_vm._v("ID")]),
                      _vm._v(" "),
                      _c("th", [_vm._v("Azienda")]),
                      _vm._v(" "),
                      _c("th", [_vm._v("Email")]),
                      _vm._v(" "),
                      _c("th", [_vm._v("Data")])
                    ...
                    _vm._v(" "),
                    _vm._l(
                      _vm.$page.user.unreadStandardRequests.slice(0, 5),
                      function(req) {
                        return _c(
                          "tr",
                          {
                            key: req.id,
                            staticClass: "w3-hover-light-gray",
                            staticStyle: { cursor: "pointer" },
                            on: {
                              click: function($event) {
                                $event.preventDefault()
                                return _vm.$inertia.visit(
                                  "/standard-requests/" + req.id
                                )
                              }
                            }
                          },
          ...
          _vm._v(" "),
          _vm.$page.user.unreadStandardRequests.length == 0
            ? _c("h4", { staticClass: "w3-display-middle" }, [
                _vm._v("Non ci suono nuove richieste")
              ])
            : _vm._e()
        ])
      ]),
      ...
      _c("div", { staticClass: "w3-col l6 m12" }, [
        _c("div", { staticClass: "w3-card-2 w3-display-container home-card" }, [
          _c("h3", { staticClass: "w3-light-gray w3-padding" }, [
            _vm._v("Nuove Richeste Express:\n                  "),
            _vm.$page.user.unreadExpressRequests.length > 0
              ? _c("b", [
                  _vm._v(
                    "\n                      " +
                      _vm._s(_vm.$page.user.unreadExpressRequests.length) +
                      "\n                  "
                  )
                ])
              : _vm._e()
            ...
            _vm.$page.user.unreadExpressRequests.length > 0
              ? _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _vm._l(
                      _vm.$page.user.unreadExpressRequests.slice(0, 5),
                      function(req) {
                        return _c(
                          "tr",
                          {
          ...
          _vm.$page.user.unreadExpressRequests.length > 0
            ? _c(
                ...
                { staticClass: "w3-panel" },
                [
                  _c("inertia-link", { attrs: { href: "/express-requests" } }, [
                    _vm._v("Vedi Tutto")
                  ])
                ],
                1
          ...
          _vm.$page.user.unreadExpressRequests.length == 0
            ? _c("h4", { staticClass: "w3-display-middle" }, [
                _vm._v("Non ci suono nuove richieste express")
              ])
            : _vm._e()
        ])
      ])
    ...
    _c("div", { staticClass: "w3-row-padding" }, [
      _c("div", { staticClass: "w3-col l6 m12" }, [
        _c("div", { staticClass: "w3-card-2 w3-display-container home-card" }, [
          _c("h3", { staticClass: "w3-light-gray w3-padding" }, [
            _vm._v("Nuovi Preventivi Easypress:\n                  "),
            _vm.$page.user.unreadEasypressRequests.length > 0
              ? _c("b", [
                  _vm._v(
                    "\n                      " +
                      _vm._s(_vm.$page.user.unreadEasypressRequests.length) +
                      "\n                  "
                  )
                ])
              : _vm._e()
            ...
            _vm.$page.user.unreadEasypressRequests.length > 0
              ? _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _vm._l(
                      _vm.$page.user.unreadEasypressRequests.slice(0, 5),
                      function(req) {
                        return _c(
                          "tr",
                          {
          ...
          _vm.$page.user.unreadEasypressRequests.length > 0
            ? _c(
                ...
                { staticClass: "w3-panel" },
                [
                  _c("inertia-link", { attrs: { href: "/easypress" } }, [
                    _vm._v("Vedi Tutto")
                  ])
                ],
                1
          ...
          _vm.$page.user.unreadEasypressRequests.length == 0
            ? _c("h4", { staticClass: "w3-display-middle" }, [
                _vm._v("Non ci suono nuovi preventivi Easypress")
              ])
            : _vm._e()
        ])
      ]),
