...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    handleConfirmationSubmit: function handleConfirmationSubmit(confirmed) {
      if (confirmed) {
        this.$inertia["delete"]("/express-requests/".concat(this.requestPendingDeletion.id));
      }
    ...
    [
                  ...
                  _vm._l(_vm.$page.requests.data, function(req) {
                    return _c(
                      "tr",
                      {
                        ...
                        class: {
                          bold: _vm.$page.user.unreadExpressRequests.find(
                            function(r) {
                              return r.id === req.id
                            }
                          )
      ...
      _vm.requestPendingDeletion
        ? _c(
            "ConfirmationDialog",
            {
              attrs: { title: "Cancellare Richiesta Express" },
